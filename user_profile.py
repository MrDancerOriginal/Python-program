...
class UserProfile(customtkinter.CTkFrame):
    def __init__(self, parent, controller):
        ...
        self.logo_label = customtkinter.CTkLabel(
            self.sidebar_frame, text="{Username}", font=customtkinter.CTkFont(size=20, weight="bold"))
        self.logo_label.grid(row=0, column=0, padx=20, pady=(20, 10))
        self.sidebar_button_1 = customtkinter.CTkButton(
            self.sidebar_frame, command=self.sidebar_button_event, text="Оновити профіль")
        self.sidebar_button_1.grid(row=1, column=0, padx=20, pady=10)
        self.sidebar_button_2 = customtkinter.CTkButton(
            self.sidebar_frame, command=self.sidebar_button_event, text="Додати блог")
        self.sidebar_button_2.grid(row=2, column=0, padx=20, pady=10)

        self.appearance_mode_label = customtkinter.CTkLabel(
            self.sidebar_frame, text="Фон:", anchor="w")
        ...
        self.scaling_label = customtkinter.CTkLabel(
            self.sidebar_frame, text="Масштаб:", anchor="w")
